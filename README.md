...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sqlalchemy-drill-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13911&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sqlalchemy-drill-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sqlalchemy-drill` can be installed with:

```
conda install sqlalchemy-drill
```

It is possible to list all of the versions of `sqlalchemy-drill` available on your platform with:
